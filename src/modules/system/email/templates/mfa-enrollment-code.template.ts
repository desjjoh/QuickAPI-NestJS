...
export const MfaEnrollmentCodeTemplate = new EmailTemplate({
  key: 'mfa-enrollment-code',
  subject: 'Confirm multi-factor authentication setup',
  tag: 'mfa-enrollment-code',
  metadata: {
    category: 'account-security',
    workflow: 'mfa-enrollment-code',
  },
  html: `
      <!doctype html>
      <html lang="en">
        <head>
          <meta charset="utf-8" />
          <title>Confirm multi-factor authentication setup</title>
        </head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;background-color:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e5e7eb;">
                  ...
                  <tr>
                    <td style="padding:0 32px 16px 32px;">
                      ...
                      <p style="margin:0 0 16px 0;font-size:16px;line-height:1.6;">
                        Use the verification code below to enable multi-factor authentication on your account.
                      </p>
                  ...
                  <tr>
                    <td style="padding:24px 32px;background-color:#f9fafb;border-top:1px solid #e5e7eb;">
                      <p style="margin:0;font-size:13px;line-height:1.5;color:#6b7280;">
                        If you did not request MFA setup, you can safely ignore this email. Do not share this code with anyone.
                      </p>
                    </td>
                  </tr>
                </table>
