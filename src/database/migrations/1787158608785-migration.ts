...
export class Migration1787158608785 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`UQ_activity_audits_event_operation\` ON \`activity_audits\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`UQ_activity_audits_event_operation\` ON \`activity_audits\` (\`event\`, \`operation_id\`)`);
