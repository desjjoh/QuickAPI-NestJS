...
export class Migration1784774887932 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` DROP COLUMN \`credentials_id\``);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`credentials_id\` varchar(16) NOT NULL`);
        await queryRunner.query(`DROP TABLE \`user_sessions\``);
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_caed45fe7b9ee802ffa015c300\` ON \`users\` (\`credentials_id\`)`);
